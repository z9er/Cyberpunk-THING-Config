...
public class PlayerHealthbarModuleConfig {
  ...
  let ShowWhenBuffsActive: Bool = false;
...
public class WorldMarkersModuleConfigPOI {
  ...
  let AlwaysShowTrackedMarker: Bool = true;
}
...
public class LHUDAddonsConfig {
  ...
  let MuteQuestNotifications: Bool = true;
  ...
  let MuteLevelUpNotifications: Bool = true;
  ...
  let RemoveHealthbarTexts: Bool = true;
  ...
  let RemoveNewAreaNotification: Bool = true;
  ...
  let RemoveMarkerPulse: Bool = true;
